 ...
 * 
 * Page for users who must change their password on first login.
 * Matches the login page design style for consistency.
 * 
 * Features:
...
export default function ChangePasswordPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      let redirectUrl = data.redirect_url || '/login';
      
      // If subdomain is provided, construct full URL with subdomain
      // Used when we need to land the user on their tenant host.
