...
export function Header({ userEmail, userName }: HeaderProps) {
  ...
  return (
    <header className="bg-white/90 border-b border-gray-200 shadow-sm sticky top-0 z-50 backdrop-blur dark:bg-gray-900/80 dark:border-gray-800">
      <div className="flex items-center justify-between px-6 h-16">
        ...
        <div className="flex items-center space-x-4 flex-1">
          ...
          <button
            ...
            className="p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:text-gray-300 dark:hover:text-gray-100 dark:focus:ring-offset-gray-900"
        ...
        <div className="flex items-center space-x-4 ml-6">
          ...
          <button className="relative p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors duration-200 dark:text-gray-300 dark:hover:text-gray-100">
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
            >
              {/* Avatar */}
              ...
              <>
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-20 dark:bg-gray-900 dark:border-gray-800">
                  ...
                  <div className="py-1">
                    <a
                      href="#"
                      className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors duration-150 dark:text-gray-200"
                      onClick={(e) => {
                        e.preventDefault();
