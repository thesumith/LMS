...
-- ============================================================================
-- This script sets up storage buckets and policies for course content
...
-- Alternative: One bucket per institute (see comments below)
-- ============================================================================
...
-- ============================================================================
-- ALTERNATIVE: ONE BUCKET PER INSTITUTE
-- ============================================================================
-- Uncomment and modify if you prefer one bucket per institute
-- ============================================================================

/*
-- Function to create bucket for new institute
CREATE OR REPLACE FUNCTION create_institute_bucket(institute_id UUID)
RETURNS void AS $$
DECLARE
    bucket_name TEXT;
BEGIN
    bucket_name := 'institute-' || institute_id::text;
...
-- Trigger to create bucket when institute is created
CREATE TRIGGER create_bucket_on_institute_insert
AFTER INSERT ON institutes
FOR EACH ROW
EXECUTE FUNCTION create_institute_bucket(NEW.id);
*/
